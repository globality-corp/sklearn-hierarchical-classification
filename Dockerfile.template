...
ARG BUILD_NUM
ARG SHA1
ENV SKLEARN-HIERARCHICAL-CLASSIFICATION__BUILD_INFO_CONVENTION__BUILD_NUM ${BUILD_NUM}
ENV SKLEARN-HIERARCHICAL-CLASSIFICATION__BUILD_INFO_CONVENTION__SHA1 ${SHA1}
COPY $NAME /src/$NAME/
